function register_npc( NPC_TYPE, NPC_NAME, WALK_LIMIT, CHILLAXIN_SPEED, ANIMATION_SPEED, TX1, TX2, TX3, TX4, TX5, 
	-- NPC max walk speed
	walk_limit..NPC_TYPE = WALK_LIMIT
	--npc just walking around
	chillaxin_speed..NPC_TYPE = CHILLAXIN_SPEED
	-- Player animation speed
	animation_speed..NPC_TYPE = ANIMATION_SPEED
	...
	available_npc_textures..NPC_TYPE = {
		texture_1 = {TX1},
		texture_2 = {TX2},
		texture_3 = {TX3},
		texture_4 = {TX4},
	...
	local npc_model..NPC_TYPE = {}
	local npc_anim..NPC_TYPE = {}
	local npc_sneak..NPC_TYPE = {}
	local ANIM_STAND = 1
	local ANIM_SIT = 2
	local ANIM_LAY = 3
	local ANIM_WALK  = 4
	...
	function npc_update_visuals(self)
		...
		npc_anim..NPC_TYPE = 0 -- Animation will be set further below immediately
		--npc_sneak..NPC_TYPE[name] = false
		prop = {
			mesh = default_model,
			textures = default_textures,
			textures = available_npc_textures..NPC_TYPE["texture_"..math.random(1,5)],
			visual_size = {x=1, y=1},
		}
	...
	NPC_ENTITY.on_step = function(self, dtime)
		...
		if self.state == 1 then
			...
			if self.npc_anim..NPC_TYPE ~= ANIM_STAND then
				self.anim = npc_get_animations(visual)
				self.object:set_animation({x=self.anim.stand_START,y=self.anim.stand_END}, animation_speed_mod, animation_blend)
				self.npc_anim..NPC_TYPE = ANIM_STAND
			end
		end
		--WALKING
